  ...
  theme: {
    extend: {
      colors: {
        page: '#141428',
        card: '#1E1E36',
        'card-elevated': '#282848',
        'card-highlight': '#32325A',
        'glass-bg': 'rgba(232, 63, 77, 0.04)',
        'glass-border': 'rgba(232, 63, 77, 0.07)',
        'glass-border-hover': 'rgba(232, 63, 77, 0.14)',
        'text-primary': '#FFFFFF',
        'text-secondary': '#B8B0CA',
        'text-muted': '#7A7490',
        'text-accent': '#E83F4D',
        'rush-low': '#10B981',
        'rush-medium': '#F59E0B',
      ...
      boxShadow: {
        ...
        'glow-orange': '0 4px 16px rgba(232, 63, 77, 0.35)',
        'glow-orange-sm': '0 2px 8px rgba(232, 63, 77, 0.25)',
        'glow-red': '0 0 12px rgba(232, 63, 77, 0.3)',
        'glow-red-lg': '0 0 20px rgba(232, 63, 77, 0.2)',
        'glow-red-pulse': '0 0 40px rgba(232, 63, 77, 0.4)',
        ...
        'token-glow': '0 0 40px rgba(232, 63, 77, 0.5), 0 0 80px rgba(232, 63, 77, 0.2)',
